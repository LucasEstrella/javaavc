...
public class TestaConta4 {
	...
	//	int contador = c1.getContadorContas();
		int contador = Conta4.getContadorContas();//Pois agora é um metodo da CLASSO por ser Static, Inicializado na Classe e não no Objeto. 
	...
	//	contador = c2.getContadorContas();
		contador = Conta4.getContadorContas();//Pois agora é um metodo da CLASSO por ser Static, Inicializado na Classe e não no Objeto. 
		System.out.println("Nosso banco possui "+contador +" contas");
	}
